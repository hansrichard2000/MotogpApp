package com.uc.motogpapp.view.splash;
...
import com.uc.motogpapp.helper.SharedPreferenceHelper;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            if (helper.getAccessToken().isEmpty()){
                ...
                action = SplashFragmentDirections.actionSplashFragmentToRiderFragment();
            }
